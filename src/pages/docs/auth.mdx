...
New accounts receive a 14-day Pro trial. After the trial, accounts revert to the Free tier. See [pricing](/products/forgeos/pricing) for paid plans.
...
> Rate limits are per API key. Contact sales@synctek.io for custom limits on Enterprise plans.
