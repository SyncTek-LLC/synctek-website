...
> **Note:** This endpoint path may change in a future release. Confirm the current path against the [MCP `forge_get_workflow` tool](/docs/mcp/) if you encounter routing issues.
