...
The full dataset, including per-dimension breakdowns and correlation analysis, is available upon request — contact [support@synctek.io](mailto:support@synctek.io).
...
[Run FTI on your packages](https://forgeos-api.synctek.io) - free for public repositories.
